...
class RealFactoring extends Component {
    ...
    async  getInvoices(){
        ...
        let response = await Apis.getRealFactoringRequests(this.props.token);
        let data = []
            ...
            <div container>
                <div className="TabView">
                        ...
                        >
                            ...
                            <Tab label="Real Factoring Requests" className={InputLabel} />
...
export default withStyles(styles)(connect(mapStateToProps, null)(withSnackbar(RealFactoring)));